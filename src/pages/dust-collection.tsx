...
// ── نوع بيانات سجل تجميع الغبار الذهبي ──
interface DustEntry {
  id: string;           // معرّف سجل الغبار
  date: string;         // تاريخ ووقت التجميع
  sectionId: string;    // معرّف القسم المُجمَّع منه
  collectedBy: string;  // اسم العامل المسؤول عن التجميع
  weightGrams: number;  // وزن الغبار المُجمَّع بالغرام
  dustType: "floor-sweep" | "polishing" | "casting" | "filing" | "mixed"; // نوع الغبار
  status: "pending-refinery" | "sent-to-refinery" | "returned"; // حالة الدفعة
  notes: string;        // ملاحظات إضافية
}

// ── بيانات تجريبية لاختبار الصفحة — تُستبدل ببيانات حقيقية عند الإنتاج ──
