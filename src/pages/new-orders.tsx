...
const routeColors: Record<string, string> = {
  "direct-melt": "bg-red-500/20 text-red-400",
...
function getRoute(order: Order) {
  if (order.isNewModel) return "New";
  if (order.totalWeightGrams > 300) return "Tree";
  return "Mixed";
}
                  ...
                  <Table>
                    ...
                    <TableBody>
                      <TableRow className="border-border/50">
                        ...
                        <TableCell>
                          {orderModel?.image ? (
                            <img src={orderModel.image} alt={orderModel.name} className="w-10 h-10 object-cover rounded-md border border-border/50" />
                          ) : (
