...
function LossCalcCard({
  ...
  // إجمالي الفاقد:
  //   مع أجزاء  → الوزن الحالي + وزن الأجزاء − آخر وزن
  //   بدون أجزاء → آخر وزن − الوزن الحالي
  const totalLoss = partsWeightTotal > 0
    ? Math.max(0, currentTotal + partsWeightTotal - effectiveLast)
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  {partsWeightTotal > 0 ? (
                    <span className="text-[10px] font-mono text-muted-foreground/70">
                      {currentTotal}g + {partsWeightTotal}g − {effectiveLast}g
                    </span>
                  ) : (
                    <span className="text-[10px] font-mono text-muted-foreground/70">
  ...
  return (
    <div className="space-y-4 max-w-[1800px] mx-auto">
      ...
      <ScanBar
        ...
        onAddQr={activeTab === "direct-melt" ? () => setScaleAddQrOpen(true) : undefined}
      />
