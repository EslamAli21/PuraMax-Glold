      ...
      items: [
        {
          ...
          children: [
            { key: "nav.analytics.overview",    label: "Overview",      path: "/analytics?tab=overview",    icon: BarChart3,      roles: ["Owner","Production Manager"] },
            { key: "nav.analytics.orders",      label: "Orders",        path: "/analytics?tab=orders",      icon: ShoppingCart,   roles: ["Owner","Production Manager"] },
            { key: "nav.analytics.lostWeight",  label: "Lost & Weight", path: "/analytics?tab=lost-weight", icon: TrendingDown,   roles: ["Owner","Production Manager"] },
            { key: "nav.analytics.departments", label: "Departments",   path: "/analytics?tab=departments", icon: Building2,      roles: ["Owner","Production Manager"] },
            { key: "nav.analytics.workers",     label: "Workers",       path: "/analytics?tab=workers",     icon: Users,          roles: ["Owner","Production Manager"] },
            { key: "nav.analytics.machines",    label: "Machines",      path: "/analytics?tab=machines",    icon: Cpu,            roles: ["Owner","Production Manager"] },
            { key: "nav.analytics.movements",   label: "Movements",     path: "/analytics?tab=movements",   icon: ArrowRightLeft, roles: ["Owner","Production Manager"] },
            { key: "nav.analytics.alerts",      label: "Alerts",        path: "/analytics?tab=alerts",      icon: BellRing,       roles: ["Owner","Production Manager"] },
            { key: "nav.analytics.comparisons", label: "Comparisons",   path: "/analytics?tab=comparisons", icon: GitCompare,     roles: ["Owner","Production Manager"] },
          ],
        },
...
function NavItemRow({
  ...
  const isOpenState = open || isChildActive;
  ...
  const rowContent = (
    <div
      ...
      onClick={showChildren && isExpanded ? (e) => { e.preventDefault(); setOpen(v => !v); } : undefined}
    >
