...
export type OrderStatus = "pending" | "approved" | "in-production" | "on-hold" | "completed" | "cancelled";
  ...
  export interface ModelPart { id: string; name: string; image?: string; stages: ProductionStage[]; }
  export interface Model { id: string; name: string; code: string; category: "rings" | "pendants" | "bracelets" | "earrings" | "chains" | "other"; karat: number; approxWeightGrams: number; stages: ProductionStage[]; notes: string; image?: string; parts?: ModelPart[]; }
