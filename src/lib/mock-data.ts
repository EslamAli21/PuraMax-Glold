export type OrderStatus = "pending" | "approved" | "in-production" | "on-hold" | "completed" | "cancelled";
  ...
  export interface ProductionStage { sectionId: string; order: number; approxLossPercent: number; }
  export interface Model { id: string; name: string; code: string; category: "rings" | "pendants" | "bracelets" | "earrings" | "chains" | "other"; karat: number; approxWeightGrams: number; stages: ProductionStage[]; notes: string; }
  ...
  export const MOCK_MODELS: Model[] = [
    { id: "m1", name: "Classic Gold Ring", code: "RNG-1012", category: "rings", karat: 18, approxWeightGrams: 4.5, stages: [{sectionId:"s1",order:1,approxLossPercent:0},{sectionId:"s2",order:2,approxLossPercent:0},{sectionId:"s3",order:3,approxLossPercent:0},{sectionId:"s4",order:4,approxLossPercent:5},{sectionId:"s5",order:5,approxLossPercent:2},{sectionId:"s7",order:6,approxLossPercent:0}], notes: "" },
    { id: "m2", name: "Leaf Pendant", code: "PEN-2045", category: "pendants", karat: 18, approxWeightGrams: 6.8, stages: [{sectionId:"s1",order:1,approxLossPercent:0},{sectionId:"s2",order:2,approxLossPercent:0},{sectionId:"s3",order:3,approxLossPercent:0},{sectionId:"s4",order:4,approxLossPercent:6},{sectionId:"s5",order:5,approxLossPercent:3},{sectionId:"s7",order:6,approxLossPercent:0}], notes: "" },
    { id: "m3", name: "Twist Bangle", code: "BGL-3108", category: "bracelets", karat: 22, approxWeightGrams: 22, stages: [{sectionId:"s4",order:1,approxLossPercent:4},{sectionId:"s5",order:2,approxLossPercent:2},{sectionId:"s7",order:3,approxLossPercent:0}], notes: "" },
    { id: "m4", name: "Drop Earrings", code: "EER-4022", category: "earrings", karat: 18, approxWeightGrams: 5.2, stages: [{sectionId:"s1",order:1,approxLossPercent:0},{sectionId:"s4",order:2,approxLossPercent:5},{sectionId:"s5",order:3,approxLossPercent:2},{sectionId:"s7",order:4,approxLossPercent:0}], notes: "" },
    { id: "m5", name: "Rope Chain", code: "CHN-5023", category: "chains", karat: 18, approxWeightGrams: 14, stages: [{sectionId:"s4",order:1,approxLossPercent:3},{sectionId:"s5",order:2,approxLossPercent:1.5},{sectionId:"s7",order:3,approxLossPercent:0}], notes: "" },
  ];
